package cl.praxis.GestionReclamos.configure;

import cl.praxis.GestionReclamos.model.service.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                       ...
                       // .requestMatchers("/complains/**").hasRole("ADMIN")
